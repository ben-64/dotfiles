if [ ! -f /usr/local/opt/powerlevel10k/powerlevel10k.zsh-theme ]; then
    # We consifer that we do not have p10k
    return
fi
...
# Generated by Powerlevel10k configuration wizard on 2021-10-09 at 19:50 CEST.
...
() {
  ...
  #typeset -g POWERLEVEL9K_VIRTUALENV_CONTENT_EXPANSION='${P9K_CONTENT}${${P9K_CONTENT:#$P9K_PYENV_PYTHON_VERSION(|/*)}:+ $P9K_PYENV_PYTHON_VERSION}'
